...
VALUES ('Administrator', 'admin@gmail.com', '$2y$10$miVcfJtIk/AuJZX85/xjbucWabqGORTHu87ykcgM5mnP/TRHoB.CO', 'admin', FALSE, 'active');

-- Insert default staff account (staff@gmail.com/admin)
INSERT INTO users (full_name, email, password_hash, role, is_first_login, status) 
VALUES ('Staff Member', 'staff@gmail.com', '$2y$10$miVcfJtIk/AuJZX85/xjbucWabqGORTHu87ykcgM5mnP/TRHoB.CO', 'staff', FALSE, 'active');
