...
(async () => {
    ...
    const i18n = {
        vi: {
            ...
            "login.btn": "ĐĂNG NHẬP",
            "login.footer": "Đăng nhập để quản lý bán hàng và tồn kho hiệu quả.",
            "login.subtitle": "QUẢN LÝ BÁN HÀNG & TỒN KHO",
            "toast.empty": "Vui lòng nhập đầy đủ thông tin!",
            "toast.success": "Đăng nhập thành công!",
            "toast.fail": "Đăng nhập thất bại",
        },
        en: {
            ...
            "login.btn": "LOGIN",
            "login.footer": "Login to manage your store's sales and inventory efficiently.",
            "login.subtitle": "SALES & INVENTORY MANAGEMENT",
            "toast.empty": "Please enter all credentials!",
